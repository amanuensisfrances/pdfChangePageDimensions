...
try {
    ...
    execSync(`ping 1.1.1.1 -n ${waitingTimeForAcrobat} > nul && taskkill /f /im AcroRd32.exe && ping 1.1.1.1 -n ${waitingTimeForPrinter} > nul`); // Wait 5 seconds then exit Adobe Acrobat Pro and then wait 5 more seconds
...
// For more info on PDF view options, visit https://thechriskent.com/2017/03/06/setting-pdf-view-options-with-pdfmark/
