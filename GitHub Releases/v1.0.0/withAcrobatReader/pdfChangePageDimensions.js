...
try {
    ...
    execSync(`ping 1.1.1.1 -n ${waitingTimeForAcrobat} > nul && taskkill /f /im AcroRd32.exe && ping 1.1.1.1 -n ${waitingTimeForPrinter} > nul`); // Wait several seconds then exit Adobe Acrobat Reader and then wait several more seconds before continuing on
